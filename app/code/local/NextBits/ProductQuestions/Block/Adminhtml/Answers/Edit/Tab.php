<?php
// echo "hiii";
class NextBits_ProductQuestions_Block_Adminhtml_Answers_Edit_Tab extends Mage_Adminhtml_Block_Widget_Tabs
{
	...
	protected function _beforeToHtml()
	{
		$this->addTab('general_section', array(
			...
			'content'   => $this->getLayout()->createBlock('productquestions/adminhtml_answers_edit_tab_forms')
			->toHtml(),
		));
