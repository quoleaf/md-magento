<?php
// echo "hiii";
class NextBits_ProductQuestions_Block_Adminhtml_Questions_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
	...
	protected function _beforeToHtml()
	{
		$this->addTab('general_section', array(
			...
			'content'   => $this->getLayout()->createBlock('productquestions/adminhtml_questions_edit_tab_form')
			->toHtml(),
		));
