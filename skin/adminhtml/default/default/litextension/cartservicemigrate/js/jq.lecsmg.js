    ...
    $.extend({
        LeCSMg: function(options){
            var defaults = {
                ...
                formSetupWrap: '#lecsmg-setup',
                formConfigWrap: '#lecsmg-config',
                formConfirmWrap: '#lecsmg-confirm',
                formImportWrap: '#lecsmg-import',
                formResumeWrap: '#lecsmg-resume',
            ...
            function createLeCookie(value){
                ...
                document.cookie = "le_cart_service_import_run="+value+expires+"; path=/";
            }

            function getLeCookie(){
                var nameEQ = "le_cart_service_import_run=";
            ...
            function deleteLeCookie(){
                ...
                var expires = "; expires="+date.toGMTString();
                document.cookie = "le_cart_service_import_run="+expires+"; path=/";
            }
            ...
            function run(){
                ...
                $(document).on('click', settings.formSetupSubmit, function(){
                    ...
                    $('#error-cart , #error-url, #error-api').hide();
