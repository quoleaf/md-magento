  ...
  _form.submit(function(e) {
    ...
    $.ajax({
      ...
      success: function(data, status, xhr) {
        ...
        if (redirect === false)
        {
          $('.ctct-embed-signup.reveal-code p').hide();
          $('.ctct-embed-signup.reveal-code h2').hide();
          $('.ctct-embed-signup.reveal-code button').hide();
          $('.ctct-embed-signup.reveal-code form').hide();
          $('#success_message_revealcode').removeClass('u-hide');
          $('#success_message_revealcode').show();
        }
